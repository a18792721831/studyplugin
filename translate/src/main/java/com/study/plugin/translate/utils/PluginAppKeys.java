package com.study.plugin.translate.utils;

public interface PluginAppKeys {
    String PLUGIN_CONFIG_ID = "com.study.plugin.translate.config.id";
    String PLUGIN_CONFIG_NAME = "在线翻译配置";
    String YOUDAO_APP_ID_SAVE_KEY = "com.study.plugin.translate.youdao.app.id";
    String YOUDAO_APP_SECRET_SAVE_KEY = "com.study.plugin.translate.youdao.app.secret";
    String BIYING_APP_ID_SAVE_KEY = "com.study.plugin.translate..biying.app.id";
    String BIYING_APP_SECRET_SAVE_KEY = "com.study.plugin.translate.biying.app.secret";
    String BAIDU_APP_ID_SAVE_KEY = "com.study.plugin.translate.baidu.app.id";
